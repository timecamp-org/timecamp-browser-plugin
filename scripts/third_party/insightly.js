function InsightlyTimer() {
    ...
    this.currentTaskId = function () {
        ...
        var tasksPattern = /details\/(Task|Tasks)\/([0-9]+)/ig;
        var projectsPattern = /details\/(Project|Projects)\/([0-9]+)/ig;
        var leadsPattern = /details\/(Lead|Leads)\/([0-9]+)/ig;
        var contactsPattern = /details\/(Contact|Contacts)\/([0-9]+)/ig;
        var opportunitiesPattern = /details\/(Opportunity|Opportunities)\/([0-9]+)/ig;
        var organizationsPattern = /details\/(Organisation|Organisations)\/([0-9]+)/ig;
    ...
    this.getParentId = function() {
        var url = document.URL;
        var reg = /\.insightly\.com\/([A-Za-z]+)/g;
    ...
    this.isButtonInserted = function () {
        ...
        return $('#main-container.details').find('header.head .btn-toolbar.pull-right').length == 0;
    };
    ...
    this.insertButtonIntoPage = function () {
        ...
        var parent = $('#main-container.details').find('header.head .btn-toolbar.pull-right');
        ...
        containter.insertBefore(parent.children().eq(0));
